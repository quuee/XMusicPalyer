...
# android 本地音乐播放器
基于 Kotlin 与 Jetpack Compose 的本地音乐播放器示例工程

## 技术栈与架构
  使用media3 mediasession架构
- 1 界面层：compose
...
- 4 本地数据存储 room
- 5 元数据读取 jaudiotagger
- 6 简单存储 SharedPreferences
